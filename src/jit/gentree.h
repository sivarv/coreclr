...
struct GenTreeCall final : public GenTree
{
    ...
    // State for supporting multi-reg returning call nodes.
...
inline bool  GenTree::IsMultiRegCall()
{
    return this->IsCall() && this->AsCall()->HasMultiRegRetVal();
}
